...
function HexagonBackground({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 -start-0 size-full overflow-hidden">
              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    "before:content-[''] before:absolute before:top-0 before:start-0 before:w-full before:h-full dark:before:bg-neutral-950 before:bg-white before:opacity-100 before:transition-all before:duration-1000",
