...
const FeaturesGrid = () => {
  return (
    <div className="grid grid-cols-1 md::grid-cols-4 relative z-10 py-10 ">
      ...
      <div className="flex flex-col lg:border-r py-10 relative group lg:border-l lg:border-b dark:border-neutral-800">
        ...
        <div className="text-lg font-bold mb-2 relative z-10 px-10">
          <div className="absolute left-0 inset-y-0 h-6 w-1 rounded-tr-full rounded-br-full bg-neutral-300 dark:bg-neutral-700 group-hover:bg-blue-500 dark:group-hover:bg-blue-500  transition duration-200" />
          <span className="group-hover:translate-x-2 transition duration-200 inline-block">
            Built for developers
          </span>
        </div>
        <p className="text-sm text-muted-foreground/50 max-w-xs mx-auto relative z-10 px-10">
      ...
      <div className="flex flex-col lg:border-r py-10 relative group lg:border-l dark:border-neutral-800">
        <div className="opacity-0 group-hover:opacity-100 transition duration-200 group absolute inset-0 h-full w-full bg-linear-to-b from-neutral-100 dark:from-neutral-800 to-transparent pointer-events-none" />
        <div className="mb-4 relative z-10 px-10">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
