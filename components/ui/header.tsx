...
export function Header() {
  ...
  return  <header
      className={cn(
        ...
        open === true ? "h-52" : "h-20",
        scrolled || open === true
          ? "backdrop-blur-nav rounded-b-4xl rounded-t-md md:max-w-7xl 2xl:max-w-[90em] bg-background [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] transform-gpu dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] shadow-xl shadow-black/5 dark:border-white/15 dark:bg-black"
