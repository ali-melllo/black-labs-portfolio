...
function IconTile({ children }: { children: React.ReactNode }) {
  return (
    <div
      className="relative flex h-16 w-16 shrink-0 items-center justify-center rounded-lg border-2 border-[rgba(255,255,255,0.20)] bg-[rgba(40,40,40)] shadow-[0px_0px_8px_0px_rgba(248,248,248,0.25)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)_inset] transition duration-200 hover:scale-[0.98]"
    >
      <div className="h-8 w-8 overflow-hidden rounded-md">{children}</div>
    </div>
  )
}

// ---------------------------------------------------------------------------
// Connector beam — the decorative L-shaped lines behind the logo grid.
// The gradient now actually travels along the path on a loop instead of
// sitting frozen at one instant.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Logo icons — attribute casing fixed (fillRule/clipRule/clipPath/stopColor/
// stopOpacity/strokeWidth). Instagram and Messenger get unique gradient /
// clipPath ids per instance since each renders twice on the page.
// ---------------------------------------------------------------------------
...
function InstagramIcon() {
  ...
  return (
    <svg viewBox="0 0 32 32" fill="none" className="h-full w-full">
      <rect x="2" y="2" width="28" height="28" rx="6" fill={`url(#${p0})`} />
      <rect x="2" y="2" width="28" height="28" rx="6" fill={`url(#${p1})`} />
      <rect x="2" y="2" width="28" height="28" rx="6" fill={`url(#${p2})`} />
      <path
...
function MessengerIcon() {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" className="h-full w-full">
      <g clipPath={`url(#${clip})`}>
        <path fill={`url(#${gb})`} d="M0 0h18v18H0V0Z" />
        <path
          fill="#F0F3FA"
      ...
      <defs>
        <linearGradient id={gb} x1="9.281" x2="9.281" y1="16" y2="-.149" gradientUnits="userSpaceOnUse">
          <stop stopColor="#0869E1" />
          <stop offset="1" stopColor="#0081FA" />
        </linearGradient>
        <linearGradient id={gc} x1="8.719" x2="7.757" y1="8.561" y2="9.888" gradientUnits="userSpaceOnUse">
          <stop stopOpacity=".15" />
          <stop offset="1" stopOpacity="0" />
        </linearGradient>
        <linearGradient id={gd} x1="9.489" x2="10.592" y1="7.168" y2="6.089" gradientUnits="userSpaceOnUse">
          <stop stopOpacity=".1" />
          <stop offset="1" stopOpacity="0" />
        </linearGradient>
        <clipPath id={clip}>
...
const TOP_ROW = [InstagramIcon, TiktokIcon, TwitterIcon, FacebookIcon, MessengerIcon, LinkedInIcon, SlackIcon]
const BOTTOM_ROW = [MessengerIcon, LinkedInIcon, SlackIcon, InstagramIcon, TiktokIcon, TwitterIcon, FacebookIcon]

export default function IntegrationDemo() {
  return (
    <div className="rounded-xl size-full group lg:col-span-2">
      <h3 className="text-lg font-semibold text-foreground ">Post to multiple platforms at once</h3>
      <p className="text-xs pt-2 font-normal text-neutral-400 max-w-sm">
        With our AI-powered platform, you can post to multiple platforms at once, saving you time and effort.
      </p>
      <div className="h-74 rounded-xl -mt-2 z-40 mask-[radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]">
        <div className="p-8 overflow-hidden h-full">
          <div className="flex flex-col gap-4 items-center justify-center h-full relative">
            <div className="flex gap-4 items-center justify-center shrink-0">
              <ConnectorBeam
                className="absolute left-1/2 -translate-x-15 -top-10 text-neutral-600"
                width={62}
                height={105}
                d="M1 -69L1 57.5C1 64.1274 6.37258 69.5 13 69.5H49C55.6274 69.5 61 74.8726 61 81.5V105"
              />
              <ConnectorBeam
                className="absolute left-1/2 translate-x-4 -bottom-2 text-neutral-600"
                width={128}
                height={69}
                d="M1 0.5L1 29.5862C1 36.2136 6.37259 41.5862 13 41.5862H115C121.627 41.5862 127 46.9588 127 53.5862V75"
                delay={1.2}
              />
              {TOP_ROW.map((Icon, i) => (
                <IconTile key={`top-${i}`}>
            ...
            <div className="flex gap-4 items-center justify-center shrink-0 ml-8">
              {BOTTOM_ROW.map((Icon, i) => (
                <IconTile key={`bottom-${i}`}>
                  <Icon />
                </IconTile>
              ))}
            </div>
