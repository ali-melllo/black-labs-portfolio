    ...
    return (
        <div className="flex w-full flex-col gap-6 py-12">
            ...
            <Message align="end">
                ...
                <MessageContent>
                    <Bubble variant={"outline"}>
                        <BubbleContent className="rounded-4xl rounded-tr-none">Expensive or Fancy Clothes , anything related </BubbleContent>
                    </Bubble>
