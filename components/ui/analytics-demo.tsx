...
const AnalyticsCard = () => {
  return (
    <div className="pt-8 px-5 rounded-xl group">
      <div className="h-full rounded-xl z-40 max-w-[16rem] mx-auto dark:bg-[#2828284d] bg-[#2828282b] mask-[radial-gradient(50%_60%_at_50%_50%,white_0%,transparent_100%)]">
        <div className="p-8 overflow-hidden h-full">
          <div className="flex flex-col gap-4 items-center justify-center h-full relative">
            <div className=" absolute left-5 -top-5 rounded-full px-4 py-2 dark:bg-neutral-400 bg-neutral-800" style={{ transform: 'none' }}>
              <p className="text-xs text-background">+200 connections</p>
            </div>
            <svg width="335" height="163" viewBox="0 0 335 163" fill="none" xmlns="http://www.w3.org/2000/svg" className="dark:text-neutral-600">
              ...
              <path d="M335 151L317.491 36.2214C317.166 34.0879 316.477 32.0245 315.57 30.0659C307.713 13.0898 308.853 1 284 1C257.738 1 244.262 37.1622 218 37.1622C191.738 37.1622 195.262 67.5 169 67.5C142.738 67.5 141.262 37.1622 115 37.1622C88.7381 37.1622 88.7141 76.5675 62.4522 76.5675C36.1902 76.5675 36.1902 54.6756 9.9283 54.6756H0" stroke="url(#gradient-3)" strokeWidth="1.5" />
              <defs>
                ...
                <linearGradient id="gradient-3" x1="70.09954%" y1="0%" x2="84.11944%" y2="0%">
            ...
            <svg width="36" height="320" viewBox="0 0 36 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute inset-x-0 -top-2 h-full w-full vertical-dots">
              ...
              <defs>
                <filter id="filter0_bdi_1_60257" x="-4" y="132" width="44" height="72" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                  <feFlood floodOpacity="0" result="BackgroundImageFix" />
            ...
            <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0 translate-x-4 m-auto h-4 w-4 cursor">
      ...
      <h3 className="text-lg font-semibold text-foreground py-2">Analytics for everything</h3>
      <p className="text-sm font-normal text-neutral-400 max-w-sm">Check analytics, track your posts, and get insights into your audience.</p>
    </div>
  );
};
